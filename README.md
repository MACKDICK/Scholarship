...
## Purpose
This repository contains general and specific Amazon Web Services CloudFormation Template for task #3 of Scholarhip ItzData
CloudFormation & ELB.
...
These are master templates that call nested templates, without having to run each template individually.

<table width="100%">
    <tr>
        <th align="left" colspan="2"><h4><a href="https://github.com/MACKDICK/Scholarhip/blob/master/orchestrators/infrastructure.yml">Infrastructure</a></h4></th>
    </tr>
    <tr>
        <td valign="top">
...
<table width="100%">
    <tr>
        <th align="left" colspan="2"><h4><a href="https://github.com/MACKDICK/Scholarship/blob/master/infrastructure/vpc.yml">VPC (Virtual Private Cloud)</a></h4></th>
    </tr>
    <tr>
...
<table width="100%">
    ...
    <tr>
        <td valign="top">
            ...
            <h6>Public S3 URL</h6># BonusBits CloudFormation Templates
